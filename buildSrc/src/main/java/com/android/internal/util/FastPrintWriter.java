...
@SuppressWarnings({"WeakerAccess", "SynchronizeOnNonFinalField", "FinalPrivateMethod", "unused"})
public class FastPrintWriter extends PrintWriter {
     ...
     * @see #print(String)
     */
    public void print(@NonNull char[] charArray) {
        synchronized (lock) {
            try {
     ...
     */
    public void println(@NonNull char[] chars) {
        print(chars);
        println();
    }
     ...
     */
    @Override
    public void write(@NonNull String str, int offset, int count) {
        synchronized (lock) {
            try {
