...
public class ComponentName implements Cloneable, Comparable<ComponentName> {
     ...
     * @param pkg The name of the package that the component exists in.  Can
     * not be null.
     * @param cls The class, Can not be null.
     */
    public ComponentName(@NonNull String pkg, @NonNull Class<?> cls) {
        this(pkg, cls.getName());
    }
    ...
    @Override
    public int compareTo(@NonNull ComponentName that) {
        int v;
