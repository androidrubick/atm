 ...
 */
@SuppressWarnings({"unused", "WeakerAccess", "StaticInitializerReferencesSubClass", "StatementWithEmptyBody", "ForLoopReplaceableByForEach"})
public abstract class Uri implements Comparable<Uri> {
    ...
    */
     ...
     * another.
     */
    public int compareTo(@NonNull Uri other) {
